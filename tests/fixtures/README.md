...
| `marked/` | marked 18.0.5 lexer tokens and off-array links | `node tools/marked-oracle/corpus.mjs`, then `node tools/marked-oracle/record.mjs --marked-module <pinned-install>` |
